...
const ATS_HOSTS = [
  ...
  "myworkdayjobs.com", "workday.com", "remotive.com", "remoteok.com", "remoteok.io",
  "bamboohr.com", "jobvite.com", "icims.com", "taleo.net", "breezy.hr", "recruitee.com",
  "linkedin.com", "indeed.com", "glassdoor.com", "ziprecruiter.com",
];

const NAME_SUFFIXES = /\b(inc|incorporated|corp|corporation|company|co|group|holdings|llc|ltd|limited|plc|gmbh|sa|ag|nv|bv)\b/g;
...
const MONOGRAM_COLORS = [
  "#D97757", "#3B82F6", "#10B981", "#F59E0B", "#8B5CF6",
  "#EC4899", "#14B8A6", "#6366F1", "#EF4444", "#0EA5E9",
];
