  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-xs px-1" style={{ color: "var(--muted-foreground)" }}>
        These are roles to look for — not real people. Use each search to find someone, then draft a
        ...
        >
          ...
          {t.searchQuery && (
            ...
            >
              ...
              >
                {copied === i ? (
                  <Check className="w-3.5 h-3.5" style={{ color: "var(--forest)" }} />
                ) : (
