    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-2 text-center">
        ...
        <p className="text-sm font-medium" style={{ color: "var(--foreground)" }}>
          No outreach saved yet
        </p>
        <p className="text-xs max-w-xs" style={{ color: "var(--muted-foreground)" }}>
          Find people at a company and draft a message — saved drafts show up here so you can track
    ...
    <div className="flex flex-col gap-3">
      {contacts.map((c) => (
        ...
        >
          ...
          {c.messageDraft && (
            <div
              className="rounded-lg px-3 py-2 text-xs leading-relaxed whitespace-pre-wrap line-clamp-4"
              style={{
