            ...
            {ACCENT_COLORS.filter((c) => c.name !== "Custom").map((c) => (
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  outline:
                    styleConfig.accentColor === c.value
                      ? `3px solid ${c.value}`
          ...
          <div style={{ display: "flex", gap: 6, marginTop: 10, alignItems: "center" }}>
            <div
              style={{
                ...
                borderRadius: 6,
                flexShrink: 0,
                background: customHex.match(/^#[0-9a-f]{6}$/i)
                  ? customHex
              ...
              {(
                [
                  { value: "line", label: "Underline", desc: "Thin accent line under headings" },
                  {
                    value: "filled",
                    label: "Filled bar",
                    desc: "Subtle colour fill behind headings",
                  },
                  { value: "minimal", label: "None", desc: "Colour only, no decorative lines" },
                ] as { value: AccentStyle; label: string; desc: string }[]
              ).map((o) => (
                <button
                  key={o.value}
                  type="button"
                  ...
                  style={{
                    ...
                    textAlign: "left",
                    border:
                      styleConfig.accentStyle === o.value
                        ? "2px solid var(--primary)"
                        : "2px solid var(--border)",
                    background:
                      styleConfig.accentStyle === o.value
      ...
      <div style={{ padding: "12px 16px", borderTop: "1px solid var(--border)", flexShrink: 0 }}>
        <button
          ...
          onClick={() => {
            onChange({
              accentColor:
                TEMPLATES.find((t) => t.id === styleConfig.templateId)?.accent ?? "#2F6B4F",
              headingFont: "Inter",
              bodyFont: "Inter",
              density: "normal",
              accentStyle: "line",
