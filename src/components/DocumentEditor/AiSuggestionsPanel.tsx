  ...
  return (
    ...
    >
      ...
      >
        ...
        {isAiGenerating &&
          (!aiMessages.length ||
            aiMessages[aiMessages.length - 1].role !== "model" ||
...
---`;
                ...
                style={{
                  ...
                  fontSize: 12,
                  fontWeight: 600,
                  cursor: tailorJdInput.trim() ? "pointer" : "not-allowed",
                  opacity: tailorJdInput.trim() ? 1 : 0.5,
                  fontFamily: "inherit",
                }}
              >
                Build prompt →
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-end", gap: 6 }}>
            <Textarea
              ...
              placeholder={
                selectedContext ? "What would you like to do with the selection?" : aiPlaceholder
              }
            ...
            <button
              type="submit"
              disabled={!chatInput.trim() || isAiGenerating || !aiChat}
              style={{
                width: 38,
                height: 38,
                borderRadius: 10,
                ...
                border: "none",
                color: "#fff",
                cursor: chatInput.trim() && !isAiGenerating && aiChat ? "pointer" : "not-allowed",
                opacity: !chatInput.trim() || isAiGenerating || !aiChat ? 0.45 : 1,
                display: "flex",
                alignItems: "center",
          ...
          {!selectedContext && (
            <p
              style={{ fontSize: 11, color: "var(--muted-foreground)", margin: 0, lineHeight: 1.4 }}
            >
