    ...
    return (
      <div className="flex-1 flex flex-col h-full relative">
        <TailorResumeWorkspace
          onBack={() => {
            onSetShowTailor(false);
            onSetTailorInitialResume(null);
          }}
    ...
    >
      ...
      <div className="flex-1 overflow-auto no-scrollbar p-8">
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 600,
                        color: "#fff",
                        cursor: loadingResumeId === r.id ? "not-allowed" : "pointer",
                        opacity: loadingResumeId === r.id ? 0.7 : 1,
                        display: "flex",
                        alignItems: "center",
                        gap: 6,
                      }}
        ...
        <ResumeGenerationForm
          ...
          onTailor={(text, name) => {
            onSetTailorInitialResume({ text, name });
            onSetShowTailor(true);
          }}
