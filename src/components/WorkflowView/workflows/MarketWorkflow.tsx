            ...
            <div style={{ maxWidth: 760, margin: "0 auto" }}>
              ...
              >
                ...
                <div style={{ fontSize: 14, color: "var(--muted-foreground)" }}>
                  Analysing market data — just a moment…
                </div>
              </MentorCard>
            </div>
          )}
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                <button
                  ...
                  style={{
                    flex: "1 1 160px",
                    height: 48,
                    background: marketSaveState === "saved" ? "var(--muted)" : "var(--card)",
                    border: "1px solid var(--border)",
                    borderRadius: 14,
                    fontFamily: "inherit",
                    fontSize: 13,
                    fontWeight: 600,
                    cursor: marketSaveState === "idle" ? "pointer" : "default",
                    color: "var(--foreground)",
                  }}
                >
                  {marketSaveState === "saving"
                    ? "Saving…"
                    : marketSaveState === "saved"
                      ? "Saved ✓"
                      : "Save comparison"}
                </button>
                <button
