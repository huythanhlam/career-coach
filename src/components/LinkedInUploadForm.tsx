...
export function LinkedInUploadForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!file) {
      setError("Please upload your LinkedIn PDF export first.");
      return;
    }
    ...
    <div style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      >
        <div style={{ padding: "22px 28px 18px", borderBottom: "1px solid var(--border)" }}>
          ...
          >
            On LinkedIn, open your profile → <strong>More</strong> → <strong>Save to PDF</strong>,
            then upload that file below. We'll score it and suggest concrete improvements.
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              >
                (optional — for the visual preview)
              </span>
            </label>
            <input
              type="url"
          ...
          <div>
            ...
            <label
              style={{
                ...
                cursor: "pointer",
                background: "var(--muted)",
                border: `1.5px dashed ${screenshotFile ? "var(--primary)" : "var(--border)"}`,
              }}
            >
              ...
              <span
                style={{
                  fontSize: 13,
                  color: screenshotFile ? "var(--foreground)" : "var(--muted-foreground)",
                  overflow: "hidden",
              ...
              >
                {screenshotFile
                  ? screenshotFile.name
                  : "Upload a full-page screenshot of your profile (taken while logged in)"}
              </span>
              <input
                type="file"
            ...
            >
              LinkedIn hides logged-out profiles, so an automated capture often can't see your
              headshot, cover photo, or summary. Uploading your own screenshot shows the real
              design.
            </p>
          </div>
