  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        >
          <h2
            style={{ fontSize: 18, fontWeight: 600, marginBottom: 20, color: "var(--foreground)" }}
          >
            {mode === "sign_in"
              ? "Sign in"
              : mode === "sign_up"
          ...
          >
            ...
            {message && (
              <p
                style={{
                  fontSize: 13,
                  color: message.error ? "var(--destructive)" : "var(--forest)",
                  margin: 0,
                }}
                role="alert"
              >
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ ...btnStyle, opacity: loading ? 0.6 : 1, marginTop: 4 }}
            >
              {loading
                ? "Please wait…"
                : mode === "sign_in"
