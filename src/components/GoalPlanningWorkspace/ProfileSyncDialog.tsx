  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "var(--card)", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}
      ...
      >
        ...
        <p className="text-xs mb-4" style={{ color: "var(--muted-foreground)" }}>
          Your survey answers differ from what's already in your profile. Choose which to overwrite
          — unchecked fields stay as they are.
        </p>
        ...
        <div className="flex gap-2 justify-end">
          ...
          <button
            ...
            disabled={syncing || selectedKeys.length === 0}
            style={{
              height: 40,
              padding: "0 20px",
              ...
              fontSize: 13,
              fontWeight: 600,
              cursor: syncing || selectedKeys.length === 0 ? "not-allowed" : "pointer",
              color: "#fff",
              display: "flex",
              alignItems: "center",
              gap: 6,
              opacity: syncing || selectedKeys.length === 0 ? 0.6 : 1,
            }}
          >
            {syncing ? (
              <>
