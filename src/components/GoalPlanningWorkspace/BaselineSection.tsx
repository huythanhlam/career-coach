...
import { Compass, ClipboardList, User as UserIcon, UserCog } from "lucide-react";
    ...
    <>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontSize: 12, color: "var(--muted-foreground)" }}>
              Just your starting point — takes a moment.
            </span>
          </div>
          <CurrentStateSurvey
            ...
            >
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 12.5, color: "var(--muted-foreground)", lineHeight: 1.55 }}
                  >
                    The coach needs your <strong>current role</strong> (and ideally your company) to
                    build a plan grounded in your real situation. Choose one:
                  </div>
                </div>
              </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        >
          ...
          >
            <li>
              Your satisfaction and what drains you shape the{" "}
              <strong>Current Situation Snapshot</strong>.
            </li>
            <li>
              What energizes you and the skills you want to grow steer which{" "}
              <strong>goals get prioritized</strong>.
            </li>
            <li>
              Your recent wins become <strong>evidence</strong> the plan builds on.
            </li>
            <li>
              Your biggest blocker becomes something the plan <strong>explicitly tackles</strong>.
            </li>
          </ul>
          <div
            style={{
          ...
          >
            The more you share, the more personal and specific your plan — but it's optional, and
            your answers save when you hit <strong>Save</strong>.
          </div>
        </div>
