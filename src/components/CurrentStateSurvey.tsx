...
const SCALES: { key: ScaleKey; label: string; low: string; high: string }[] = [
  ...
  {
    key: "compensationSatisfaction",
    label: "Happy with your compensation",
    low: "Underpaid",
    high: "Well paid",
  },
  ...
  {
    key: "recognition",
    label: "Recognized for your contributions",
    low: "Overlooked",
    high: "Valued",
  },
];
...
const TEXTS: { key: TextKey; label: string; placeholder: string }[] = [
  {
    key: "energizers",
    label: "What energizes you most in your current role?",
    placeholder: "e.g. mentoring teammates, solving gnarly architecture problems",
  },
  {
    key: "frustrations",
    label: "What frustrates or drains you most right now?",
    placeholder: "e.g. unclear priorities, too many meetings, no path to promotion",
  },
  {
    key: "recentWins",
    label: "Your proudest wins in the last 6–12 months?",
    placeholder: "e.g. led the payments migration, mentored a junior to mid-level",
  },
  {
    key: "skillsToGrow",
    label: "Which skills do you most want to use or grow?",
    placeholder: "e.g. system design, people management, public speaking",
  },
  {
    key: "biggestBlocker",
    label: "The #1 thing holding you back from your next step?",
    placeholder: "e.g. lack of visibility, missing a key skill, no open headcount",
  },
];

export function CurrentStateSurvey({
  initial,
  isSaving,
  onSave,
  onCancel,
        ...
        {(showBaseline || baselineOnly) && (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2" style={{ gap: 14 }}>
              <div>
                <label htmlFor="survey-company" style={labelStyle}>
                  Company
                </label>
                <ComboInput
                  id="survey-company"
              ...
              <div>
                <label htmlFor="survey-yearsExperience" style={labelStyle}>
                  Years of experience
                </label>
                <input
              ...
              {SCALES.map((s) => (
                <div key={s.key}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 11, color: "var(--muted-foreground)", width: 64 }}>
                      {s.high}
                    </span>
                    {(() => {
          ...
          >
            {isSaving ? (
              ...
              <>
                ...
                {baselineOnly ? "Save baseline" : "Save current-state survey"}
              </>
            )}
          </button>
        </div>
