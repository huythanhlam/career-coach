...
interface Props {
  state: Pick<
    ResumeFormState,
    "showImport" | "importText" | "importType" | "isImporting" | "importError"
  >;
  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={() => {
          dispatch({ type: "SET_SHOW_IMPORT", payload: !showImport });
      ...
      {showImport && (
        <div
          style={{ padding: 20, borderTop: "1px solid var(--border)", background: "var(--card)" }}
        >
          <div className="flex gap-2 mb-4">
            {(["linkedin", "resume"] as const).map((t) => (
              <button
                ...
                type="button"
                onClick={() => {
                  dispatch({ type: "SET_IMPORT_TYPE", payload: t });
                  dispatch({ type: "SET_IMPORT_ERROR", payload: null });
                }}
                style={{
                  padding: "5px 14px",
                  ...
                  fontFamily: "inherit",
                  cursor: "pointer",
                  background: importType === t ? "var(--primary)" : "transparent",
                  borderColor: importType === t ? "var(--primary)" : "var(--border)",
                  color: importType === t ? "#fff" : "var(--muted-foreground)",
                }}
              >
          ...
          {importType === "linkedin" ? (
            <div className="flex flex-col gap-3">
              <p className="text-xs" style={{ color: "var(--muted-foreground)" }}>
                On LinkedIn, go to your profile → <strong>More → Save to PDF</strong>. Upload that
                file here and we'll extract your work history, education, and skills automatically.
              </p>
              <input
                ref={linkedinFileRef}
                type="file"
                ...
                style={{ display: "none" }}
                onChange={(e) => onFileUpload(e, "linkedin")}
              />
              <button
                type="button"
                ...
                <div style={{ marginTop: 10 }}>
                  ...
                  >
                    {isImporting ? (
                      ...
                      <>
                        <Upload className="w-3.5 h-3.5" /> Extract & Fill Form
                      </>
                    )}
                  </button>
                </div>
            ...
            <div className="flex flex-col gap-3">
              <p className="text-xs" style={{ color: "var(--muted-foreground)" }}>
                Upload your resume (PDF, DOCX, or TXT) and we'll extract your experience, education,
