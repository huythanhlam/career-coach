...
interface Props {
  state: Pick<ResumeFormState, "workHistory" | "expandedWorkIndices" | "autoGeneratedEntries" | "autoGeneratingEntries" | "isGeneratingBullets" | "targetRole" | "targetRoleSelect">;
...
export const WorkHistorySection = React.memo(function WorkHistorySection({ state, dispatch }: Props) {
  const { workHistory, expandedWorkIndices, autoGeneratedEntries, autoGeneratingEntries, isGeneratingBullets, targetRole, targetRoleSelect } = state;
  ...
  const handleSuggestBullets = async (index: number) => {
    ...
    try {
      ...
      newWork[index] = { ...newWork[index], responsibilities: currentText ? currentText + "\n\n" + suggestions : suggestions };
      dispatch({ type: "SET_WORK_HISTORY", payload: newWork });
      dispatch({ type: "SET_AUTO_GENERATED_ENTRIES", payload: autoGeneratedEntries.filter((i) => i !== index) });
    } catch (err) {
  ...
  const addWork = () => {
    ...
    dispatch({ type: "SET_WORK_HISTORY", payload: [...workHistory, { company: "", role: "", startDate: "", endDate: "", responsibilities: "", current: false }] });
  ...
  const removeWork = (index: number) => {
    ...
    dispatch({ type: "SET_EXPANDED_WORK_INDICES", payload: expandedWorkIndices.filter((i) => i !== index).map((i) => (i > index ? i - 1 : i)) });
  };
            ...
            {isComplete && !isExpanded ? (
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" onClick={() => dispatch({ type: "SET_EXPANDED_WORK_INDICES", payload: [...expandedWorkIndices, idx] })}
              ...
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  ...
                  <div className="flex items-center gap-2">
                    {isComplete && (
                      <button type="button" onClick={() => dispatch({ type: "SET_EXPANDED_WORK_INDICES", payload: expandedWorkIndices.filter((i) => i !== idx) })}
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                      <div className="flex items-center gap-2">
                        ...
                        {autoGeneratedEntries.includes(idx) && !autoGeneratingEntries.includes(idx) && (
