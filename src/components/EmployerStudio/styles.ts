...
export const cardStyle: React.CSSProperties = {
  ...
  padding: 22, boxShadow: "0 8px 30px rgba(0,0,0,0.04)",
};
...
export const textareaStyle: React.CSSProperties = {
  ...
  padding: "12px 14px", fontFamily: "inherit", fontSize: 14, color: "var(--foreground)",
...
export const primaryBtn: React.CSSProperties = {
  ...
  alignItems: "center", justifyContent: "center", gap: 8, boxShadow: "0 4px 14px rgba(217,119,87,0.25)",
};
...
export const pillBtn: React.CSSProperties = {
  ...
  borderRadius: 9999, border: "1px solid var(--border)", background: "var(--card)",
  color: "var(--foreground)", fontFamily: "inherit", fontSize: 12, fontWeight: 600, cursor: "pointer",
};
