...
const INDUSTRY_OPTIONS = INDUSTRIES.filter((i) => i.value !== "other").map((i) => ({
  value: i.label,
  label: i.label,
}));
  ...
  const handleSave = async () => {
    const cleaned: Draft = {
      ...
      headquarters: draft.headquarters?.trim()
        ? normalizeLocation(draft.headquarters)
        : draft.headquarters,
    };
        ...
        <div style={{ ...cardStyle, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div>
            ...
            <input
              ...
              style={fieldStyle(errors.tagline)}
            />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <div>
              ...
              <SelectWithOther
                ...
                otherPlaceholder="Specify your industry"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <input
              ...
              style={fieldStyle(errors.logoUrl)}
            />
