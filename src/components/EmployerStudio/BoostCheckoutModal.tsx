      ...
      >
        ...
        <div style={{ padding: 22, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          >
            <ShieldCheck
              className="w-4 h-4"
              style={{ color: "var(--forest, #2F6B4F)", flexShrink: 0 }}
            />
            <span>
              Simulated checkout — this is a demo and <strong>no real payment</strong> is processed.
            </span>
          </div>
          ...
          >
            ...
            {paying
              ? "Processing…"
              : `Pay ${formatPrice(tier.amountCents)} & feature for ${tier.days} days`}
          </button>
