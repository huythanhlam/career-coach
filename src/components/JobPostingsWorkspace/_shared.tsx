...
export function SectionHeading({
  ...
  return (
    <div style={{ marginBottom: noMargin ? 0 : 14 }}>
      ...
      {sub && (
        <div
          style={{ fontSize: 12, color: "var(--muted-foreground)", marginTop: 3, marginLeft: 24 }}
        >
          {sub}
        </div>
      )}
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 14 }}>
        ...
        >
          ...
          <div className="eyebrow" style={{ fontSize: 8, marginTop: 2 }}>
            fit
          </div>
        </div>
        <div style={{ minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <h3
              className="font-display"
              style={{ fontSize: 17, fontWeight: 600, color: "var(--foreground)", margin: 0 }}
            >
              {label}
            </h3>
          </div>
        ...
        {fit.factors.map((f) => (
          <div key={f.key}>
            ...
            >
              ...
              <span style={{ fontSize: 13, fontWeight: 700, color: barColor(f.score) }}>
                {f.score}%
              </span>
            </div>
            <div
