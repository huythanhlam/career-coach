// Deterministic follow-up nudge generation for the nightly `generate-nudges`
// cron (Coach OS F1 Slice B). Template-only — no AI — so the run is free and
// reliable. See docs/superpowers/specs/2026-07-07-coach-os-f1-design.md §7.
//
